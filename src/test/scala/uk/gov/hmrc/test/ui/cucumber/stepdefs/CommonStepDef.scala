...
class CommonStepDef extends BaseStepDef {
  ...
  And("""^I fill section2""") { () =>
    ...
    if (!isClearance) {
      OtherPartiesInvolvedPage.fillPage(CommonStepDef.genSequenceId("first"), "Consolidator", "GB121212121212");
      continue()
    ...
    AuthorisationPage.fillPage(CommonStepDef.genSequenceId("first"), "ACR", "GB123456789008");
    continue()
  ...
  And("""^I fill section3""") { () =>
    DestinationCountryPage.fillPage("China");
    continue()
  ...
  And("""^I fill section5""") { () =>
    ...
    continue()
    CommodityDetailsPage.fillPage("4203400090", "Straw for bottles");
    continue()
