...
import uk.gov.hmrc.test.ui.pages.section2.CarrierAddressPage

class CarrierAddressStepDef extends BaseStepDef {

  And("""^I should land on Carrier-Address page""")(() => CarrierAddressPage.checkPage())
