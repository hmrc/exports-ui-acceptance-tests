...
object DeclarantDetailsPage extends BasePage {
  ...
  def checkPageTitle(): Unit = {
    DeclarantDetailsPage.pageTitle(homePageTitle)
  }

  def selectOptionForISYourEori(selectOption: String)(implicit declarantDetails: Map[String, String]): Map[String, String] =  {
    selectOption match {
