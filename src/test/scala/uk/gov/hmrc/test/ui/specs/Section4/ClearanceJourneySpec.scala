...
import uk.gov.hmrc.test.ui.pages.base.CommonPage.*
import uk.gov.hmrc.test.ui.pages.section2.{EntryIntoDeclarantRecordsPage, ProcedureChoicePage}
...
class ClearanceJourneySpec
  ...
  Feature("Section4 Clearance Journey") {
    Scenario(
      ...
      check title on previous documents page when Entry Into Declarant records is Yes
       and authorisation choice is Permanent with excise*/
