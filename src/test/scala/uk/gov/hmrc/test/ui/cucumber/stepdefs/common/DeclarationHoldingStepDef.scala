...
import uk.gov.hmrc.test.ui.pages.common.DeclarationHoldingPage

class DeclarationHoldingStepDef extends BaseStepDef {

  And("""^I should land on holding page and redirect to Confirmation page""") { () =>
